...
function draw_tiles(t)
	...
	local sx,sy=(t%16)*8,flr(t/16)*8
	
	local ix,iy = flr(camera_x_offset/8), flr(camera_y_offset/8)
	...
	for y=iy-1,iy+16 do
		...
		if full(x,y) then
			...
			if not full(x-1,y) then
				sspr(sx+16,sy,4,8,x*8,y*8)
				left=true
			else
				--inside corner
				if not full(x-1, y+1) then
					sspr(sx+24,sy+4,4,4,x*8,y*8+4)
				end
				if not full(x-1, y-1) then
					sspr(sx+24,sy,4,4,x*8,y*8)
				end
			end
		
		-- right side tile
			if not full(x+1,y) then
				sspr(sx+20, sy, 4, 8,x*8+4,y*8)
				right=true
			else
				--inside corner
				if not full(x+1, y+1) then
					sspr(sx+28,sy+4,4,4,x*8+4,y*8+4)
				end
				if not full(x+1, y-1) then
					sspr(sx+28,sy,4,4,x*8+4,y*8)
				end
			end
			
			-- ground tile
			if not full(x,y-1) then
				sspr(sx+8,sy,8,5,x*8,y*8)
				-- outside corner
				if right then
					sspr(sx+36,sy,4,5,x*8+4,y*8)
				end
				if left then
					sspr(sx+32,sy,4,5,x*8,y*8)
				end
			end
			
			-- ceiling tile
			if not full(x,y+1) then
				sspr(sx+8,sy+5,8,3,x*8,y*8+5)
				-- outside corner
				if right then
					sspr(sx+36,sy+5,4,3,x*8+4,y*8+5)
				end
				if left then
					sspr(sx+32,sy+5,4,3,x*8,y*8+5)
				end
			end
...
function generate_world()
	...
	local map_noise = {
		watersp, watersp, watersp, watersp,
		grasssp, grasssp, rocksp , rocksp,
		rocksp , rocksp , rocksp , rocksp,
		rocksp , rocksp , rocksp , rocksp,
	}
...

...

...

...
__gff__

